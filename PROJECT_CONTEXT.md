...
- **액트별 5대 동적 환경 테마 배경 시스템 (`actThemes.ts`)**:
  - Act 1 (수도원/카타콤): 핏빛 와인 & 암회색 안개 (`slate-950/red-950`)
  - Act 2 (루트 골레인 사막/무덤): 황금 호박석 & 모래바람 (`amber-950/yellow-950`)
  - Act 3 (쿠라스트 정글/사원): 맹독 에메랄드 & 핏빛 늪 (`emerald-950/teal-950`)
  - Act 4 (불타는 지옥): 흑요석 & 끓어오르는 용암 지옥불 (`black/red-950/orange-950`)
  - Act 5 (아리앗 설산): 빙하 시안 & 세계석 코스믹 바이올렛 (`cyan-950/indigo-950`)
- **20종 보스 전수 고유 아이콘 및 6대 대악마 시그니처 전략 기믹 구현**:
  - 안다리엘 (`🦂`): 맹독 분사 (보호막 즉시 부식 + 전장 맹독 DoT)
  - 두리엘 (`🪲`): 결빙 오라 (회피율 0% 억제) & 흉포한 2.2배 관통 돌진
  - 메피스토 (`💀`): 증오의 뇌격 방패 (70% 피해 감소 결계) & 번개 폭격
  - 디아블로 (`👹`): 붉은 번개 숨결 (보호막 소각 + 2.5배 파멸적 지옥불 피해)
  - 3대 고대인 (`⚔️`): 3인의 강철 방진 태세 (70% 피해 감소 & 휠윈드)
  - 바알 (`🐙`): 파멸의 분노 소각 (플레이어 분노 50% 소각 + 촉수 타격 & 바알 분신 소환)
  - 기타 14종 보스: 시체 폭발, 암흑 화살비, 지옥 모루 분쇄, 공성 투석기 포격 등 보스별 고유 기믹/소환 적용.
