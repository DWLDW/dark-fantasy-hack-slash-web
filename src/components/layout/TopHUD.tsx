        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <button
              ...
              className="p-1.5 bg-blood-950/80 hover:bg-blood-900 border border-blood-700/80 text-blood-300 hover:text-white rounded shadow transition flex items-center gap-1 text-[10px] font-mono font-bold"
