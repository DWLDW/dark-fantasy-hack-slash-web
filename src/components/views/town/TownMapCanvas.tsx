...
export const TownMapCanvas: React.FC<TownMapCanvasProps> = React.memo(({
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border-2 border-brass-600/80 shadow-[0_0_50px_rgba(0,0,0,0.9)] bg-iron-950 aspect-[4/3] sm:aspect-[16/10] max-h-[64vh] w-full select-none font-sans">
      ...
      {/* 3. Top-Left Camp Header Badge */}
      <div className="absolute top-3 left-3 sm:top-4 sm:left-4 z-20 pointer-events-none space-y-1">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-iron-950/90 border border-brass-500/80 shadow-2xl text-brass-200 text-xs sm:text-sm font-cinzel font-black tracking-wide">
          <span>❖ 로그 캠프 (Rogue Encampment)</span>
          <span className="px-1.5 py-0.2 rounded bg-blood-950 border border-blood-600 text-blood-300 text-[10px] font-mono font-bold">1막 성역 거점</span>
        </div>
      ...
      <button
        ...
        className="absolute top-[32%] left-[22%] -translate-x-1/2 -translate-y-1/2 z-20 group cursor-pointer flex flex-col items-center"
      >
        <div className="relative">
          <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-blue-950/90 border-2 border-blue-400 group-hover:border-amber-300 group-hover:scale-115 transition flex items-center justify-center text-blue-300 group-hover:text-amber-200 shadow-[0_0_20px_rgba(59,130,246,0.7)] group-hover:shadow-[0_0_30px_rgba(251,191,36,0.9)]">
        ...
        <div className="mt-1 px-2.5 py-0.5 rounded-lg bg-iron-950/95 border border-blue-500/70 group-hover:border-amber-400 text-white font-cinzel font-black text-[10px] sm:text-xs whitespace-nowrap shadow-xl transition transform group-hover:scale-105">
          📜 데커드 케인
        </div>
      ...
      <button
        ...
        className="absolute top-[35%] left-[78%] -translate-x-1/2 -translate-y-1/2 z-20 group cursor-pointer flex flex-col items-center"
      >
        <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-amber-950/90 border-2 border-amber-400 group-hover:border-yellow-300 group-hover:scale-115 transition flex items-center justify-center text-yellow-300 group-hover:text-yellow-100 shadow-[0_0_20px_rgba(245,158,11,0.7)] group-hover:shadow-[0_0_30px_rgba(251,191,36,0.9)]">
          <Dices className="w-5 h-5 sm:w-6 sm:h-6" />
        </div>
        <div className="mt-1 px-2.5 py-0.5 rounded-lg bg-iron-950/95 border border-amber-500/70 group-hover:border-yellow-300 text-white font-cinzel font-black text-[10px] sm:text-xs whitespace-nowrap shadow-xl transition transform group-hover:scale-105">
          🎲 기드의 암시장
        </div>
      ...
      >
        <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-purple-950/90 border-2 border-purple-400 group-hover:border-purple-300 group-hover:scale-115 transition flex items-center justify-center text-purple-300 group-hover:text-white shadow-[0_0_20px_rgba(168,85,247,0.7)] group-hover:shadow-[0_0_30px_rgba(192,132,252,0.9)]">
          <Sparkles className="w-5 h-5 sm:w-6 sm:h-6" />
        </div>
        <div className="mt-1 px-2.5 py-0.5 rounded-lg bg-iron-950/95 border border-purple-500/70 group-hover:border-purple-300 text-white font-cinzel font-black text-[10px] sm:text-xs whitespace-nowrap shadow-xl transition transform group-hover:scale-105">
          🔮 룬워드 공방
        </div>
      ...
      >
        <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-emerald-950/90 border-2 border-emerald-400 group-hover:border-emerald-300 group-hover:scale-115 transition flex items-center justify-center text-emerald-300 group-hover:text-emerald-100 shadow-[0_0_20px_rgba(16,185,129,0.7)] group-hover:shadow-[0_0_30px_rgba(52,211,153,0.9)]">
          <Box className="w-5 h-5 sm:w-6 sm:h-6" />
        </div>
        <div className="mt-1 px-2.5 py-0.5 rounded-lg bg-iron-950/95 border border-emerald-500/70 group-hover:border-emerald-300 text-white font-cinzel font-black text-[10px] sm:text-xs whitespace-nowrap shadow-xl transition transform group-hover:scale-105">
          🧪 호라드릭 큐브
        </div>
      ...
      <button
        onClick={onWorldMap}
        className="absolute top-[14%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-20 group cursor-pointer flex flex-col items-center"
      >
        <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-blood-950/90 border-2 border-blood-500 group-hover:border-amber-300 group-hover:scale-115 transition flex items-center justify-center text-blood-400 group-hover:text-amber-200 shadow-[0_0_20px_rgba(239,68,68,0.7)] group-hover:shadow-[0_0_30px_rgba(251,191,36,0.9)]">
          <Compass className="w-5 h-5 sm:w-6 sm:h-6" />
        </div>
        <div className="mt-1 px-2.5 py-0.5 rounded-lg bg-iron-950/95 border border-blood-600 group-hover:border-amber-400 text-white font-cinzel font-black text-[10px] sm:text-xs whitespace-nowrap shadow-xl transition transform group-hover:scale-105">
          ⚔️ 성역 원정 관문
        </div>
      </button>
    </div>
