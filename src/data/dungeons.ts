...
export const DUNGEONS_DATA: DungeonInfo[] = [
  ...
  },
  {
    ...
    rooms: [
      { id: 1, type: 'start', title: '루트 골레인 성문', cleared: true, current: false, connections: [2] },
      { id: 2, type: 'normal', title: '잊혀진 도시 지하', cleared: true, current: false, connections: [3, 4], monsterCount: 30 },
      { id: 3, type: 'rune', title: '사막의 룬 제단', cleared: false, current: false, connections: [5], rewardDesc: 'Amn / Sol 룬 제단' },
      { id: 4, type: 'treasure', title: '파라오의 황금 석관', cleared: false, current: true, connections: [5], rewardDesc: '중급 룬 및 샤크스킨 방어구' },
      { id: 5, type: 'shrine', title: '태양의 성소', cleared: false, current: false, connections: [6], rewardDesc: '행운/방어 축복 성소' },
      { id: 6, type: 'boss', title: '진정한 탈 라샤의 방', cleared: false, current: false, connections: [], monsterCount: 30, rewardDesc: '두리엘의 유령 (구교복/소켓 무기 드랍)' }
    ]
  },
  {
    id: 'act3_jungle',
    ...
    rooms: [
      { id: 1, type: 'start', title: '쿠라스트 부두', cleared: true, current: false, connections: [2] },
      { id: 2, type: 'normal', title: '거미 숲 늪지대', cleared: true, current: false, connections: [3, 4], monsterCount: 30 },
      { id: 3, type: 'elite', title: '트라빈칼 평의회 석실', cleared: false, current: true, connections: [5], monsterCount: 30, rewardDesc: '하이 카운실 (고급 룬/유니크 악세)' },
      { id: 4, type: 'rune', title: '증오의 룬 제단', cleared: false, current: false, connections: [5], rewardDesc: 'Shael / Um / Mal 룬 제단' },
      { id: 5, type: 'treasure', title: '핏빛 보물창고', cleared: false, current: false, connections: [6], rewardDesc: '엘리트 소켓 장비 및 보석' },
      { id: 6, type: 'boss', title: '증오의 억류지 3층', cleared: false, current: false, connections: [], monsterCount: 30, rewardDesc: '메피스토의 환영 (샤코/조던링/워트래블러)' }
    ]
  },
  {
    id: 'act4_chaos',
    ...
    rooms: [
      { id: 1, type: 'start', title: '판데모니움 요새', cleared: true, current: false, connections: [2] },
      { id: 2, type: 'normal', title: '절망의 평원', cleared: true, current: false, connections: [3, 4], monsterCount: 30 },
      { id: 3, type: 'elite', title: '불길의 강 대장간', cleared: false, current: true, connections: [5], monsterCount: 30, rewardDesc: '대장장이 헤파스토 (Ist / Gul 룬 드랍)' },
      { id: 4, type: 'shrine', title: '혼돈의 성소', cleared: false, current: false, connections: [5], rewardDesc: '지옥의 축복 버프' },
      { id: 5, type: 'rune', title: '지옥불 룬 제단', cleared: false, current: false, connections: [6], rewardDesc: 'Vex / Ohm / Lo 최고급 룬 제단' },
      { id: 6, type: 'boss', title: '오각성 중앙 제단', cleared: false, current: false, connections: [], monsterCount: 30, rewardDesc: '공포의 군주 디아블로 (마라/할배검/윈드포스)' }
    ]
  },
  {
    id: 'act5_worldstone',
    ...
    rooms: [
      { id: 1, type: 'start', title: '하로가스 성채', cleared: true, current: false, connections: [2] },
      { id: 2, type: 'normal', title: '피의 언덕 전초기지', cleared: true, current: false, connections: [3, 4], monsterCount: 30 },
      { id: 3, type: 'treasure', title: '아리앗 고대인의 금고', cleared: false, current: true, connections: [5], rewardDesc: '엘리트 유니크 풀세트 드랍' },
      { id: 4, type: 'elite', title: '세계석 성채 3층', cleared: false, current: false, connections: [5], monsterCount: 30, rewardDesc: '바알의 선봉대 (Ber / Jah / Cham 룬 드랍)' },
      { id: 5, type: 'rune', title: '파괴의 룬 제단', cleared: false, current: false, connections: [6], rewardDesc: 'Jah / Cham / Zod 궁극의 룬 제단' },
      { id: 6, type: 'boss', title: '파멸의 옥좌 심연', cleared: false, current: false, connections: [], monsterCount: 30, rewardDesc: '파멸의 군주 바알 (종결 신기 및 고대 룬 대량 드랍)' }
    ]
  }
];
