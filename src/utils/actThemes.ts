...
export const ACT_THEMES: Record<number, ActTheme> = {
  1: {
    ...
    bgGradient: 'bg-gradient-to-b from-slate-950 via-red-950/35 to-black',
    containerBg: 'bg-gradient-to-b from-iron-950/90 via-red-950/40 to-iron-950/90',
    borderColor: 'border-red-700/70',
    glowShadow: 'shadow-[0_0_42px_rgba(185,28,28,0.35)]',
    ambientGlow: 'bg-red-600/20',
  ...
  2: {
    ...
    bgGradient: 'bg-gradient-to-b from-stone-950 via-amber-950/40 to-zinc-950',
    containerBg: 'bg-gradient-to-b from-stone-950/90 via-amber-950/40 to-stone-950/90',
    borderColor: 'border-amber-600/70',
    glowShadow: 'shadow-[0_0_42px_rgba(217,119,6,0.38)]',
  ...
  3: {
    ...
    bgGradient: 'bg-gradient-to-b from-slate-950 via-emerald-950/40 to-stone-950',
    containerBg: 'bg-gradient-to-b from-slate-950/90 via-emerald-950/40 to-slate-950/90',
    borderColor: 'border-emerald-600/70',
    glowShadow: 'shadow-[0_0_42px_rgba(5,150,105,0.38)]',
  ...
  4: {
    ...
    bgGradient: 'bg-gradient-to-b from-black via-red-950/55 to-black',
    containerBg: 'bg-gradient-to-b from-black/90 via-orange-950/50 to-black/90',
    borderColor: 'border-red-500/80',
    glowShadow: 'shadow-[0_0_48px_rgba(239,68,68,0.45)]',
  ...
  5: {
    ...
    bgGradient: 'bg-gradient-to-b from-slate-950 via-cyan-950/40 to-indigo-950/50',
    containerBg: 'bg-gradient-to-b from-slate-950/90 via-indigo-950/40 to-slate-950/90',
    borderColor: 'border-cyan-500/70',
    glowShadow: 'shadow-[0_0_48px_rgba(6,182,212,0.4)]',
    ambientGlow: 'bg-cyan-500/22',
